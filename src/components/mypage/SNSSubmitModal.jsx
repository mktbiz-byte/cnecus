                ...
                {[1, 2, 3, 4].map(week => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!hasVideo && !hasSns && (
                        <div className="text-xs text-gray-400 mt-1">No video</div>
                      )}
                    </button>
                  )
                })}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {campaign?.target_platforms?.instagram && (
                <span className="text-xs bg-pink-50 text-pink-700 px-2 py-1 rounded">📸 Instagram</span>
              )}
              {campaign?.target_platforms?.tiktok && (
                <span className="text-xs bg-gray-50 text-gray-700 px-2 py-1 rounded">🎵 TikTok</span>
              )}
              {campaign?.target_platforms?.youtube && (
                <span className="text-xs bg-red-50 text-red-700 px-2 py-1 rounded">📺 YouTube</span>
              )}
            </div>
          </div>
          ...
          {requiresAdCode && (
            <div>
              ...
              <button
                ...
                className="w-full mt-2 text-left text-sm text-purple-600 hover:text-purple-800 flex items-center justify-between"
              >
