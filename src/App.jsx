...
import MeetingConsultations from './components/admin/MeetingConsultations';
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/meeting-consultations" element={<ProtectedRoute requireAdmin={true}><MeetingConsultations /></ProtectedRoute>} />
      </Routes>
    </div>
  );
};
